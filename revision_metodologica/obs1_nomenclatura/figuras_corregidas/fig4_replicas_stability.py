...
import os
# ROOT apunta al repositorio oficial (de solo lectura: aqui solo se copian los
...
# Correccion observacion 1.1: la adaptacion (pesos fijos 0,5/0,5) se rotula
# SANNWR-adaptado en toda tabla, figura y conclusion, para no sugerir que se
# valido la arquitectura publicada por Ni et al. (2022).
SOURCES = [
    ("GNNWR",  ROOT/"modelos"/"gnnwr"/"output_log"/"gnnwr_log_replicas_summary.csv", "#2196F3"),
    ("SANNWR-adaptado", ROOT/"modelos"/"sannwr"/"output_log_real"/"sannwr_real_log_replicas_summary.csv","#4CAF50"),
]

DETAIL_PATHS = {
    "GNNWR":  ROOT/"modelos"/"gnnwr"/"output_log"/"gnnwr_log_replicas.csv",
    "SANNWR-adaptado": ROOT/"modelos"/"sannwr"/"output_log_real"/"sannwr_real_log_replicas.csv",
}
